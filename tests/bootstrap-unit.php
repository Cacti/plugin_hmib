...
if (!function_exists('hmib_test_mock_db')) {
	function hmib_test_mock_db($fn, $match, $result) {
		$GLOBALS['__test_db_fixtures'][] = array('fn' => $fn, 'match' => $match, 'result' => $result);
	}
}

if (!function_exists('hmib_test_reset_db_mocks')) {
	function hmib_test_reset_db_mocks() {
		$GLOBALS['__test_db_fixtures'] = array();
	}
}

if (!function_exists('hmib_test_db_result')) {
	function hmib_test_db_result($fn, $sql, $params, $default) {
...
if (!function_exists('db_fetch_assoc')) {
	function db_fetch_assoc($sql) {
		return hmib_test_db_result('db_fetch_assoc', $sql, array(), array());
	}
}

if (!function_exists('db_fetch_assoc_prepared')) {
	function db_fetch_assoc_prepared($sql, $params = array()) {
		return hmib_test_db_result('db_fetch_assoc_prepared', $sql, $params, array());
	}
}

if (!function_exists('db_fetch_row')) {
	function db_fetch_row($sql) {
		return hmib_test_db_result('db_fetch_row', $sql, array(), array());
	}
}

if (!function_exists('db_fetch_row_prepared')) {
	function db_fetch_row_prepared($sql, $params = array()) {
		return hmib_test_db_result('db_fetch_row_prepared', $sql, $params, array());
	}
}

if (!function_exists('db_fetch_cell')) {
	function db_fetch_cell($sql) {
		return hmib_test_db_result('db_fetch_cell', $sql, array(), '');
	}
}

if (!function_exists('db_fetch_cell_prepared')) {
	function db_fetch_cell_prepared($sql, $params = array()) {
		return hmib_test_db_result('db_fetch_cell_prepared', $sql, $params, '');
	}
}
...
if (!function_exists('db_table_exists')) {
	function db_table_exists($table) {
		return hmib_test_db_result('db_table_exists', $table, array(), false);
	}
}
