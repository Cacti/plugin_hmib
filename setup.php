...
function hmib_setup_table () {
	...
	db_execute("INSERT INTO `plugin_hmib_hrSystemTypes` VALUES
		...
		(17,'.1.3.6.1.4.1.311.1.1.3.1.2', 'Windows Version 6.3 (Build 14','Windows 2016 Server','2016'),
                (18,'.1.3.6.1.4.1.311.1.1.3.1.2', 'Windows Version 6.3 (Build 9','Windows 2016 Server','2016'),
                (19,'.1.3.6.1.4.1.311.1.1.3.1.2', 'Windows Version 6.3 (Build 17','Windows 2019 Server','2019'),
		(20,'.1.3.6.1.4.1.8072.3.2.10', 'Linux','Linux','Linux'),
		(21,'.1.3.6.1.4.1.8072.3.2.10', 'Linux%gentoo%','Gentoo Linux','Gentoo'),
		(22,'.1.3.6.1.4.1.8072.3.2.10', 'Linux%ubuntu%','Ubuntu','ubuntu'),
		(23,'.1.3.6.1.4.1.8072.3.2.10', 'Linux%centos%','CentOS','CentOS'),
		(24,'.1.3.6.1.4.1.8072.3.2.10', 'Linux%ndlp%','McAfee Network DLP','DLP'),
		(25,'.1.3', 'Linux%PAE%','Cisco UCM or CCX','UCM'),
		(26,'.1.3', 'Identity Services Engine','Cisco ISE','ISE'),
		(27,'.1.3', 'Cisco Prime Infrastructure','Cisco Prime Infrastructure','Prime'),
		(28,'.1.3', 'AsyncOS','Cisco Web Security Appliance','WSA'),
		(29,'.1.3', 'UCOS','Cisco Unity','CUC'),
		(30,'.1.3.6.1.4.1.2.3.1.2.1.1.3', 'IBM%AIX%06.01%','AIX','6.1'),
		(31,'', 'VMware ESXi','VMware ESXi','ESXi');");
